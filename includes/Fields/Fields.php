			...
			array(
				...
				'fields'     => array(
					array(
						...
						'show_more'   => array(
							'{sale_percent}'  => esc_html__( 'Discount percentage, e.g. 25%. Only applies when product is on sale.', 'lime-product-labels' ),
							'{sale_amount}'   => esc_html__( 'Discount amount in store currency, e.g. $5.00. Only applies when product is on sale.', 'lime-product-labels' ),
							'{stock_qty}'     => esc_html__( 'Stock quantity, e.g. 12. Empty when stock management is off.', 'lime-product-labels' ),
							'{stock_status}'  => esc_html__( 'In Stock or Out of Stock.', 'lime-product-labels' ),
							'{regular_price}' => esc_html__( 'Regular price, e.g. $20.00.', 'lime-product-labels' ),
							'{sale_price}'    => esc_html__( 'Current/sale price, e.g. $15.00.', 'lime-product-labels' ),
							'{sku}'           => esc_html__( 'Product SKU.', 'lime-product-labels' ),
						),
					),
				),
			),
